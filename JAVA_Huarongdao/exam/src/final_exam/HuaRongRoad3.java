...
public class HuaRongRoad3 extends JFrame implements MouseListener{
  ...
  public static void main(String[] args) {//主函数，用于创建Frame
    HuaRongRoad3 huarongroad = new HuaRongRoad3();
  }
  ...
  void initCharacher(){
    ...
    button[0].setBounds(200,300,200,200);//确定位置和大小
    button[1].setBounds(200,100,200,100);
    ...
    button[9].setBounds(300,200,100,100);
    this.getContentPane().add(restart, null);
    this.getContentPane().add(jLabel_text, null);
    this.getContentPane().add(jLabel_num, null);
  ...
  void restart_actionPerformed(ActionEvent e) {//点击重新开始
    HuaRongRoad3 huarong=new HuaRongRoad3();//重新建立一次
    this.dispose();
  }
  void winning()
  {
